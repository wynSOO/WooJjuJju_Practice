package app.com.woo_project.fragment;
...
import app.com.woo_project.adpater.GoDataViewAdapter;
import app.com.woo_project.models.GoDataListVO;
import app.com.woo_project.service.GodataGetterService;

// Fragment class 반드시 v4.app의 Fragment를 import 한다.
public class MainFragment extends Fragment{
    ...
    // Fragment를 ViewPager에 표시하기 위해서는 반드시 빈(기본) 생성자를 만들어 주어야한다.
    public MainFragment() {
    }
    ...
    public static MainFragment newInstance(String pageTitle ,int menu_id) {
        ...
        // 보통 클래스에 맴버변수를 세팅하는 방법은
        // this.getTitle = title; 이렇게 사용하나
        ...
        //newInstance가 받은 pageTitle을 Fragment에 심는 절차
        Bundle string = new Bundle();

        string.putString(PAGE_TITLE,pageTitle);
        string.putInt("NUM",001);// 맴버변수 선언을 하지 않아도 된다.
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_main,container,false);// super.onCreateView(inflater, container, savedInstanceState);
...
//        GoDataGetterService goGettor = new GoDataGetterService();
//        List<GoDataListVO> goDataList = goGettor.execute(100);
